...
- **Data Location:** `./data/Images/` with labels in `./data/df_cleaned.csv`
...
For a **Watch** image:
- **DINOv2:** Highlights the entire watch face, band, and surrounding wrist (context)
- **ResNet:** Focuses on reflective metallic surfaces and watch face details (texture)

For **Baby Care → Home Furnishing** misclassification:
- **Both models:** Activate on soft textures and pastel colors
- **Explanation:** Visual similarity legitimately confuses both architectures
- **DINOv2advantage:** Slightly better at incorporating shape context
